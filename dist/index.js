...
const { get } = __nccwpck_require__(319)

const serviceName = 'jira'
const { format } = __nccwpck_require__(310)
const client = __nccwpck_require__(805)(serviceName)
...
const fetch = __nccwpck_require__(422)
